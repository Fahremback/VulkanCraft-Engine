...
class Runtime final : public IPluginIsolationManager {
...
std::unique_ptr<IPluginIsolationManager> create_plugin_isolation_runtime(){return std::make_unique<Runtime>();}
}
